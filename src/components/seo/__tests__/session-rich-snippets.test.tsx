...
vi.mock("lucide-react", () => ({
  Clock: ({ size, ...props }: any) => <svg data-testid="clock-icon" height={size} width={size} {...props} />,
  Dumbbell: ({ size, ...props }: any) => <svg data-testid="dumbbell-icon" height={size} width={size} {...props} />,
  Timer: ({ size, ...props }: any) => <svg data-testid="timer-icon" height={size} width={size} {...props} />,
}));
