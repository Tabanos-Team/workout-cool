...
vi.mock("next/image", () => ({
  __esModule: true,
  default: (props: any) => {
    return <img alt={props.alt} src={props.src?.src || props.src} {...props} />;
  },
}));
...
describe("Componentes de Toast (Radix UI Base)", () => {
  ...
  it("debería aplicar las clases variantes de class-variance-authority", async () => {
    ...
    const { rerender } = render(
      <ToastProvider>
        <Toast data-testid="toast-variant" open={true} variant="destructive">
    ...
    rerender(
      <ToastProvider>
        <Toast data-testid="toast-variant" open={true} variant="black">
